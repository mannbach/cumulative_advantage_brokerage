...
class MetricCollaboratorSeriesBrokerageFrequencyComparison(MetricMixin):
    __tablename__ = "metric_collaborator_series_brokerage_frequency_comparison"

    stage = Column(Integer)
    max_stage_curr = Column(Integer)
    max_stage_next = Column(Integer)
    ...
    __table_args__ = (
        Index(
            "idx_metric_collaborator_series_brokerage_frequency_comparison",
