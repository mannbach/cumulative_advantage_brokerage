...
def main():
    ...
    file_out = os.path.join(
        config[ARG_PATH_CONTAINER_OUTPUT], "si_brokerage_frequency_gender_comparison.pdf")
    ...
    fig, _, l_legends = plot_gender_comparison(
        tpl_d_tests_bf_cmp_gender=tpl_d_test,
    )
